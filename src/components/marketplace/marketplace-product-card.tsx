...
export function MarketplaceProductCard({
  ...
  return (
    <div className="group flex flex-col rounded-xl border border-border bg-card overflow-hidden hover:border-primary/40 hover:shadow-sm transition-all duration-200">
      {/* Primary Product Clickable Area */}
      <Link href={targetHref} className="flex flex-1 flex-col">
      ...
      {/* Producer Provenance & Location (Separate Sibling Link - No Nested Anchors) */}
      <div className="p-4 pt-3 mt-auto">
        <div className="flex items-center gap-1.5 border-t border-border/60 pt-2.5 text-xs text-foreground/80">
          ...
          {farmerClerkId ? (
            ...
            >
              ...
              <span className="text-foreground font-semibold group-hover/farmer:underline">{farmerName}</span>
              {product.farmer?.city ? (
